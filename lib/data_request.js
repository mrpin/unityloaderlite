unity.DataRequest = function (start, end, crunched, audio)
{
    ...
    {
        name             = name_value;
        name_with_prefix = 'fp ' + name;

        unity.DataRequest.requests_list.push(this);
    ...
    this["onload"] = function (byte_array)
    {
        this.finish(byte_array.subarray(start, end));
    };
...
unity.DataRequest.requests_list = [];