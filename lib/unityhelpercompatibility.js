var unityhelpercompatibility = function ()
{
    var self = {};
    ...
    var has_web_gl = function ()
    {
        ...
        else
        {
            ...
            var gl_context = self.get_gl_context(canvas);
    ...
    var is_browser = function (name)
    {
        return browser_uagent.indexOf(name) != -1;
    };
    ...
    self["get_gl_context"] = function (target)
    {
        ...
        {
            result = target.getContext("webgl");

            if (!result)
            {
                result = target.getContext("experimental-webgl");
            }
        }
    ...
    self["compatibility_check"] = function ()
    {
        var need_back = false;
        ...
        else if (is_mobile(navigator.userAgent || navigator.vendor || window.opera))
        {
        ...
        else if (!is_browser("Firefox") && !is_browser("Chrome") && !is_browser("Safari"))
        {
